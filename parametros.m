...
ml_vec = linspace(Ms+Mc_min,Ms+Mc_max,20);
ml_vec = [Ms,ml_vec]; %Se explicita que el primer valor de Ml debe ser el escenario para spreader vacio, masa Ms
l_vec  = linspace(0,45,20);
vt_vec = linspace(0,vt_max,20);
at_vec = linspace(-at_max,at_max,20);
